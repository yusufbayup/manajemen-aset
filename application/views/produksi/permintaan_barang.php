    ...
    <div class="col-lg-12 grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <p><small>Jika sudah diproses oleh admin warehouse maka data permintaan tidak dapat di ubah atau di hapus <span style="color: red;">*</span></small></p>
                <a href="<?= base_url() ?>Produksi/Tambah_Request_Permintaan_Barang"><button type="button" class="btn btn-primary"><i data-feather="plus"></i> Tambah Data</button></a>
...
<script src="<?= base_url() ?>assets/public/js/produksi/request_permintaan_barang.js"></script>