<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Inventory/Data_Barang_Masuk">Data Barang Masuk</a></li>
...
<div class="row">
    ...
    <a href="<?= base_url() ?>Inventory/Data_Barang_Masuk"><button class="btn btn-secondary"><i data-feather="arrow-left-circle"></i> Back</button></a>
</div>
...
<script src="<?= base_url() ?>assets/public/js/barang_masuk_detail.js"></script>