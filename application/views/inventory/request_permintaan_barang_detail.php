<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Inventory/Request_Permintaan_Barang">Request Permintaan Barang</a></li>
...
<div class="row">
    ...
    <a href="<?= base_url() ?>Inventory/Request_Permintaan_Barang"><button class="btn btn-secondary btn-sm"><i data-feather="arrow-left-circle"></i> Back</button></a>
</div>
