...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Data Kategori Barang</h6>
                ...
                <div class="table-responsive" style="margin-top: 10px;">
                    <table id="table_kategori" style="width: 100%;" class="table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th style="text-align: center;">Nama Kategori Barang</th>
        ...
        <div class="modal-content">
            ...
            <form action="" id="form_delete">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="id" id="id_kategori_hapus">
                </div>
                <div class="modal-footer">
