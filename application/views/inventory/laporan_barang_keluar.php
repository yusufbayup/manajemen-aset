...
<div class="row">
    ...
    <div id="doc_print">
        ...
        <div class="col-lg-12">
            <hr>
            <h4 style="text-align: center;">Data Barang Keluar</h4>
            <hr>
            <div class="table-responsive mt-3">
                <table id="table_po" style="width: 100%;" class="table table-bordered">
                    ...
                    <tbody id="print_table_barang_keluar">
                    </tbody>
                </table>
            </div>
        </div>
...
<script src="<?= base_url() ?>assets/public/js/laporan_barang_keluar.js"></script>