        ...
        columns: [{
            ...
            render: function(data, type, row) {
                ...
                if(row.status_permintaan == 'Waiting') {
                    return `<div style="text-align:center;"><a href="../Produksi/Detail_Request_Permintaan_Barang/${row.id_permintaan}"><button class="btn btn-secondary btn-sm"><i class="fa fa-search"></i></button></a>
                    <a href="../Produksi/Edit_Request_Permintaan_Barang/${row.id_permintaan}"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o"></i></button></a>
                    <button class="btn btn-danger btn-sm" id="btn_hapus" data-id="${permintaan}"><i class="fa fa-trash-o"></i></button></div>`
                } else {
                    return `<div style="text-align:center;"><a href="../Produksi/Detail_Request_Permintaan_Barang/${row.id_permintaan}"><button class="btn btn-secondary btn-sm"><i class="fa fa-search"></i></button></a></div>`
                }
